...
class Config:
    ...
    PASSWORD_RESET_URL = (
        os.environ.get("PASSWORD_RESET_URL") or "http://localhost:5000/reset"
    )
    NEWSLETTER_RESET_URL = (
        os.environ.get("PASSWORD_RESET_URL")
        or "http://localhost:5000/newsletter-conformation"
    )
